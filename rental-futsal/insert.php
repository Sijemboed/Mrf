...
$insert = mysqli_query($connect, "INSERT INTO booking SET nama='$nama', no_telepon='$no_telepon', tanggal='$tanggal', waktu='$waktu', durasi='$durasi', no_lapangan='$no_lapangan', keterangan='$keterangan' ");
