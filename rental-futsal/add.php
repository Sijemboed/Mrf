...
<body>
    <header>
        <nav class="navbar navbar-expand-lg bg-light shadow" data-bs-theme="light">
            <div class="container-fluid mx-5">
                <!-- Logo -->
                <a class="navbar-brand" href="index.php">MyRoom</a>
    ...
    <main>
        <div class="d-flex justify-content-center mt-5">
            <h2 class="text-primary fw-medium">Meet Now</h2>
        </div>
        ...
        <div class="d-flex justify-content-center mt-5">
            ...
            <form action="insert.php" method="post">
                ...
                <div class="mb-3">
                    <label for="noLapangan" class="form-label">Our Meeting Room</label>
                    <select class="form-select" name="no_lapangan" id="noLapangan">
                        <option value="1">Meeting Room 101</option>
                        <option value="2">Meeting Room 201</option>
                        <option value="3">Meeting Room 202</option>
                        <option value="4">Meeting Room 401</option>
                        <option value="4">Meeting Room 402</option>
                    </select>
                </div>
